...
const Products = ({ product, category }) => {
  ...
  return (
    <>
      <div className="w-full flex-col flex bg-blue-300 rounded-xl p-4">
        <h3 className="py-4 font-medium  text-xl text-gray-100">
          ĐIỆN MÁY - DA DỤNG
        </h3>
      ...
      <div className="w-full mb-4 rounded-xl bg-purple-500 p-4">
        <h3 className="py-4 font-medium text-xl text-gray-100">LAPTOP</h3>
        <div className="flex gap-2 ">
      ...
      <div className="w-full mb-4 rounded-xl bg-green-500 p-4">
        <h3 className="py-4 font-medium text-xl text-gray-100">LINH KIỆN</h3>
        <div className="flex gap-2 ">
          {data2[0]?.products?.map((el) => (
            <Link
              className="flex"
              key={el?.id}
              to={`/${data1[0]?.slug}/${el?.id}/`}
      ...
      <div className="w-full mb-4 rounded-xl bg-gray-50 p-4">
        <h3 className="py-4 font-medium text-xl">Sản phẩm nổi bật</h3>
          ...
          {product &&
            product?.map((el) => (
              <Link
                ...
                to={`/${data1[0]?.slug}/${el?.id}/`}
              >
                <div className=" w-[170px]  border rounded-lg h-[265px] bg-gray-100 flex flex-col gap-2 cursor-pointer  ">
                  <img
                    className="rounded-t-lg w-full h-[148px]"
                    src={el?.thumbnail}
                    alt="home_product"
