      ...
      <div className="flex flex-6 ">
        <Link to={`/${path.HOME}`}>
          <img
            src={logo}
            alt="logo"
            className="w-[351px] h-[35px] ml-[120px] mr-[50px] my-[10px] object-cover"
          />
        </Link>
        <div className="flex   pitems-center w-[539px] h-[40px] my-[10px] border border-gray-200 rounded-lg placeholder:text-gray-500 justify-between">
          <div className="flex py-2 gap-2  ">
            <input
              onChange={(e) => setValue(e.target.value)}
              type="text"
              className="w-[500px] h-[21px] outline-none border-none px-4 placeholder:border-none placeholder:outline-none"
